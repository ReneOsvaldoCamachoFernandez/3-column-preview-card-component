...
export default function Home() {
  return (
    <>
      ...
      <main className="h-full bg-[#F2F2F2] px-[24px] py-[88px]">
        <div className="flex flex-col font-lex">
          <div className="w-full bg-[#E38826] p-[50px] ">
            <Image src={SedanIco} alt="ico" className="mb-11"></Image>
            <h1 className="text-[#F2F2F2] font-bold mb-[33px] text-4xl font-big">
              Sedans
            </h1>
            <p className="text-[#FFFFFF]/75 font-normal mb-[33px]">
              Choose a sedan for its affordability and excellent fuel economy.
              Ideal for cruising in the city or on your next road trip.
            </p>
            <button className="bg-[#F2F2F2] rounded-full font-bold text-[#E38826] px-8 py-3">
              Learn More
            </button>
          </div>
          <div className="w-full bg-[#006970] p-[50px] ">
            ...
            <button className="bg-[#F2F2F2] rounded-full font-bold text-[#006970] px-8 py-3">
              Learn More
            </button>
          </div>
          <div className="w-full bg-[#004241] p-[50px] ">
            ...
            <button className="bg-[#F2F2F2] rounded-full font-bold text-[#004241] px-8 py-3">
              Learn More
            </button>
          </div>
        </div>
